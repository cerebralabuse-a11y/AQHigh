  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        twitter:
          "bg-[#1DA1F2] text-white shadow-lg hover:bg-[#1DA1F2]/90 hover:shadow-xl hover:shadow-[#1DA1F2]/30 hover:scale-105 active:scale-95",
        danger:
          "bg-gradient-to-r from-destructive to-primary text-white shadow-lg hover:shadow-xl hover:shadow-destructive/30 hover:scale-105 active:scale-95",
      },
      size: {
